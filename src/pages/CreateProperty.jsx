        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12 border border-base-300">
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                {...register('propertyName' , {required: {value: true, message: 'Property name is required'}})}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select {...register('category' , {required: {value: true, message: 'Category is required'}})} className="w-full px-4 py-3 rounded-lg border border-base-300 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-200 bg-white">
            ...
            <div>
              ...
              <input
                ...
                {...register('imgURL' , {required: {value: true, message: 'Image link is required'}})}
                className="w-full px-4 py-3 rounded-lg border border-base-300 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-200"
              />
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    value={user?.email}
                    {...register('userEmail' , {required: {value: true, message: 'Email is required'}})}
                    readOnly
                    className="w-full px-4 py-2.5 rounded-lg border border-base-300 bg-gray-50 text-gray-600 cursor-not-allowed"
                  />
                </div>
